...
"""
Outline API Documentation Fetcher

Fetches the official Outline OpenAPI spec from the outline/openapi GitHub
repo and converts it into organized markdown files grouped by tag.
"""
...
OPENAPI_URL = "https://raw.githubusercontent.com/outline/openapi/main/spec3.json"
...
def fetch_url(url: str, timeout: int = 60) -> str | None:
    req = Request(url, headers={"User-Agent": "outline-api-docs-fetcher/1.0"})
    try:
...
def sync(args: argparse.Namespace) -> None:
    ...
    print("Fetching Outline OpenAPI spec...")
    ...
    main_lines = ["# Outline API Documentation\n"]
    info = spec.get("info", {})
...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch Outline API docs from OpenAPI spec and convert to markdown"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
