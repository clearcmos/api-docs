...
"""
Sonarr API Documentation Fetcher

Fetches the official Sonarr OpenAPI (v3) spec from GitHub and converts it
...
OPENAPI_URL = "https://raw.githubusercontent.com/Sonarr/Sonarr/develop/src/Sonarr.Api.V3/openapi.json"
APP_NAME = "Sonarr"
SOURCE_DOCS_URL = "https://sonarr.tv/docs/api/"
...
def fetch_url(url: str, timeout: int = 60) -> str | None:
    req = Request(url, headers={"User-Agent": "sonarr-api-docs-fetcher/1.0"})
    try:
